...
-- Backward compatibility for datapacks/modules that still use ResourceTypes.*
-- Newer code uses RESOURCE_* globals exported by the core.
if not ResourceTypes then
	ResourceTypes = {
		BANK = RESOURCE_BANK,
		BANK_BALANCE = RESOURCE_BANK,
		INVENTORY_MONEY = RESOURCE_INVENTORY_MONEY,
		GOLD_EQUIPPED = RESOURCE_INVENTORY_MONEY,
		INVENTORY_CURRENCY_CUSTOM = RESOURCE_INVENTORY_CURRENCY_CUSTOM,
		PREY_CARDS = RESOURCE_PREY_CARDS,
		TASK_HUNTING = RESOURCE_TASK_HUNTING,
		TASK_HUNTING_POINTS = RESOURCE_TASK_HUNTING,
		FORGE_DUST = RESOURCE_FORGE_DUST,
		FORGE_SLIVER = RESOURCE_FORGE_SLIVER,
		FORGE_CORES = RESOURCE_FORGE_CORES,
		LESSER_GEMS = RESOURCE_LESSER_GEMS,
		REGULAR_GEMS = RESOURCE_REGULAR_GEMS,
		GREATER_GEMS = RESOURCE_GREATER_GEMS,
		LESSER_FRAGMENT = RESOURCE_LESSER_FRAGMENT,
		GREATER_FRAGMENT = RESOURCE_GREATER_FRAGMENT,
		BOUNTY_POINTS = RESOURCE_BOUNTY_POINTS,
		SOULSEALS_POINTS = RESOURCE_SOULSEALS_POINTS,
	}
end
