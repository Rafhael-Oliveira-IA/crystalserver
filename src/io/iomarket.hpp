...
public:
	...
	static void createOffer(uint32_t playerId, uint8_t worldId, MarketAction_t action, uint32_t itemId, uint16_t amount, uint64_t price, uint8_t tier, bool anonymous);
